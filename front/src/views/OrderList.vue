...
<template>
    <div class="order">
        ...
        <v-card class="mx-auto my-5" max-width="380" v-for="requests in one" v-bind:key="requests.O_NUM" elevation="0">
        ...
        <div class="mx-auto my-5" style="margin-top: 15px; max-width: 380px;">
            <div id="requestDelivery" style="margin-bottom: 10px;"><b>세탁 준비중</b></div> <!--&nbsp;&nbsp;좀 남발하지마세요 제발 ㅠ-->
        </div>
        <v-card class="mx-auto my-5" max-width="380" v-for="requests in two" v-bind:key="requests.O_NUM" elevation="0">
            <!-- <div v-if="index === 0 || request.date !== requests[index - 1].date" style="margin-bottom: 5px;"> -->
            <div id="O_DAY">
                <p class="mb-2">{{ requests.O_DAY }}</p>
            </div>
            <div class="order-box">
                ...
                <div class="order-btn" style="text-align: right;">
                    <v-card-actions style="display: flex; align-items: center;">
                        <v-btn id="accept" icon="mdi-check" variant="outlined" size="32px" style="border-radius: 15%;"
                            @click="clickAccept2(requests.O_NUM)"></v-btn>
                        <v-btn id="cancel" icon="mdi-close" variant="outlined" size="32px" style="border-radius: 15%;"
                            @click="rejectRequest(requests.O_NUM)"></v-btn>
                        <v-btn id="moreInfo" icon="mdi-plus" variant="outlined" size="32px" style="border-radius: 15%;"
                            v-bind:to="{ path: '/orderlist/details', query: { id: requests.O_NUM } }"></v-btn>
        ...
        <div class="mx-auto my-5" style="margin-top: 15px; max-width: 380px;">
            <div id="requestDelivery" style="margin-bottom: 10px;"><b>배송중</b></div> <!--&nbsp;&nbsp;좀 남발하지마세요 제발 ㅠ-->
        </div>
        <v-card class="mx-auto my-5" max-width="380" v-for="requests in thr" v-bind:key="requests.O_NUM" elevation="0">
            <!-- <div v-if="index === 0 || request.date !== requests[index - 1].date" style="margin-bottom: 5px;"> -->
            <div id="O_DAY">
                <p class="mb-2">{{ requests.O_DAY }}</p>
            </div>
            <div class="order-box">
                ...
                <div class="order-btn" style="text-align: right;">
                    <v-card-actions style="display: flex; align-items: center;">
                        <v-btn id="accept" icon="mdi-check" variant="outlined" size="32px" style="border-radius: 15%;"
                            @click="clickAccept3(requests.O_NUM)"></v-btn>
                        <v-btn id="cancel" icon="mdi-close" variant="outlined" size="32px" style="border-radius: 15%;"
                            @click="rejectRequest(requests.O_NUM)"></v-btn>
                        <v-btn id="moreInfo" icon="mdi-plus" variant="outlined" size="32px" style="border-radius: 15%;"
                            v-bind:to="{ path: '/orderlist/details', query: { id: requests.O_NUM } }"></v-btn>
